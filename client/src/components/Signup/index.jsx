...
import { API_URL } from "../../config"; // make sure API_URL points to deployed backend
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        authLogin(data.user, data.token); // assuming backend sends token
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://findmyspace-backend1.onrender.com/image/background.jpg')", // ✅ full URL
      }}
    >
